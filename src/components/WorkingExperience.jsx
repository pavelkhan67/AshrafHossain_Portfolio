...
import img from "../assets/WorkingExperience.json"

const WorkingExperience = () => {
    return (
        <div className='pt-7 md:pt-10' id='experience' >
            <div className='bg-gray-200 py-5'>
                <div className='md:grid grid-cols-3'>
                    ...
                    <div className='col-span-2 pl-2 lg:pl-5 pr-2 lg:pr-10 text-base text-start md:text-justify flex flex-col'>
                        <h2 className='text-3xl md:text-4xl font-semibold py-2 lg:py-5' style={{ color: 'rgba(31, 52, 122, 1)' }}>Working Experience</h2>
