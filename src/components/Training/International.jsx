...
const International = () => {
    return (
        <div className='ps-2 space-y-3 text-base text-start md:text-justify' id='international' >
            <h2 className='text-2xl md:text-3xl font-semibold pt-5 md:pt-0' style={{ color: 'rgba(31, 52, 122, 1)' }}>International</h2>
            <p>Here goes my International Training</p>
