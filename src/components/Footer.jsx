...
const Footer = () => {
    return (
        <div className='pt-7 md:pt-10'>
            <footer className="footer ps-4 py-5 md:ps-10 md:pe-10 md:py-8 bg-neutral text-neutral-content ">
                <aside className='text-start'>
                    ...
                    <p className='text-base md:text-sm'>MD. Ashraf Hossain<br />Deputy Secretary, <br />Government of the People's Republic of Bangladesh.</p>
            ...
            <div className='bg-color border-r-2 border-l-2 text-start text-sm md:text-base md:flex justify-between px-2 py-3 space-y-2 md:space-y-0'>
